...
require(boot)
rquire(corrplot)
dataf <- read.csv("~/Downloads/nbt.3154-S3.csv")
...
lows <- data.frame(gene = par(mar = rep(0, 4))character(), onetwo = numeric(), twothree = numeric(), threefourg = numeric(), threefourgf = numeric(), fourgfourgf = numeric(), stringsAsFactors = FALSE)
